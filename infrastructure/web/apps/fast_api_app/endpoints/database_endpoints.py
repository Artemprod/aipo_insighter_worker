...
from domain.enteties.buisnes_models import TranscribedText, SummaryText
from infrastructure.web.apps.fast_api_app.models.get_models import ResponseTranscribedText
