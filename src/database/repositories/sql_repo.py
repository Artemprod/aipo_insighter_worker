...
from src.consumption.models.buisnes_models import TranscribedText, SummaryText, AIAssistant, WorkerStatus
from src.database.models.text_process_models import (TranscribedTexts as TranscribedTextModel,
